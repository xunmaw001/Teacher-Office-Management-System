...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>领导管理</span></li>
								<li class="breadcrumb-item active"><span>领导列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">领导列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										领导账号
									</label>
									<input type="text" id="lingdaozhanghaoSearch" class="form-control form-control-sm" placeholder="请输入领导账号" aria-controls="tableId">
									<label>
										领导姓名
									</label>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#lingdaozhanghaoSearch').val() != null && $('#lingdaozhanghaoSearch').val() != ''){
				searchForm.lingdaozhanghao ="%" +  $('#lingdaozhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("lingdao/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				lingdaozhanghao : searchForm.lingdaozhanghao,	
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("lingdao/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"lingdao");
