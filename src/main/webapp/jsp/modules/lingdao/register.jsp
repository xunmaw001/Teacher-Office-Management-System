...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210512/1538119b18674bd6a9c6f4c24bb6484d.jpeg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper {
		...
		background-color: rgba(16, 91, 146, 0);
	...
	#registerForm .form-group .label {
		width: 72px;
		line-height: 44px;
		margin: -480px 10px 0 0;
		color: rgba(16, 91, 146, 1);
		font-size: 14px;
		padding: 0;
		border-radius: 0;
		border-width: 0;
		border-style: solid;
		border-color: rgba(16, 91, 146, 1);
	...
	#registerForm button.pull-right {
		...
		border-style: solid;
		border-color: #ccc;
		background-color: rgba(16, 91, 146, 1);
		box-shadow: 0 0 6px rgba(30, 144, 255, 0);
	}
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">领导账号</label> 
							<input  name="lingdaozhanghao" placeholder="领导账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">领导姓名</label> 
							<input  name="lingdaoxingming" placeholder="领导姓名" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "lingdao/register";
				$.ajax({ 
					type: "POST",
					url: url,
